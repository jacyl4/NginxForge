#define NGX_CONFIGURE " --prefix=/etc/nginx --sbin-path=/usr/sbin/nginx --modules-path=/usr/lib/nginx/modules --conf-path=/etc/nginx/nginx.conf --error-log-path=/var/log/nginx/error.log --http-log-path=/var/log/nginx/access.log --pid-path=/run/nginx.pid --lock-path=/run/nginx.lock --http-client-body-temp-path=/var/cache/nginx/client_temp --http-proxy-temp-path=/var/cache/nginx/proxy_temp --http-fastcgi-temp-path=/var/cache/nginx/fastcgi_temp --http-uwsgi-temp-path=/var/cache/nginx/uwsgi_temp --http-scgi-temp-path=/var/cache/nginx/scgi_temp --user=www-data --group=www-data --with-compat --with-file-aio --with-threads --with-libatomic --with-http_ssl_module --with-http_v2_module --with-http_v3_module --with-http_realip_module --with-http_addition_module --with-http_sub_module --with-http_dav_module --with-http_flv_module --with-http_mp4_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_auth_request_module --with-http_random_index_module --with-http_secure_link_module --with-http_degradation_module --with-http_slice_module --with-http_stub_status_module --with-stream --with-stream_ssl_module --with-stream_ssl_preread_module --with-stream_realip_module --with-pcre-jit --with-zlib=/home/jacyl4/GitLab/nginx/compile/zlib-x86_64_v3 --add-module=/home/jacyl4/GitLab/nginx/compile/ngx_brotli --add-module=/home/jacyl4/GitLab/nginx/compile/zstd-nginx-module --add-module=/home/jacyl4/GitLab/nginx/compile/ngx_devel_kit --with-openssl=/home/jacyl4/GitLab/nginx/compile/boringssl-x86_64_v3 --with-cc=gcc --with-cpp=g++ --with-cc-opt='-march=x86-64-v3 -O3 -pipe -fstack-protector-strong -fPIC -D_FORTIFY_SOURCE=2 -DTCP_FASTOPEN=23 -I/home/jacyl4/GitLab/nginx/compile/boringssl-x86_64_v3/.openssl/include -flto' --with-ld-opt='-Wl,-z,relro,-z,now,--as-needed -L/home/jacyl4/GitLab/nginx/compile/boringssl-x86_64_v3/.openssl/lib -lstdc++ -lmimalloc -flto'"
